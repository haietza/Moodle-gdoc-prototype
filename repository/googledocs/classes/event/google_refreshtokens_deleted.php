 ...
 */
namespace repository_googledocs\event;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class google_refreshtokens_deleted extends \core\event\base {

    /**
     * Initialise required event data properties.
     */
    protected function init() {
        $this->data['objecttable'] = 'google_refreshtokens';
        $this->data['crud'] = 'd';
    ...
    public static function get_name() {
        return get_string('eventtokendeleted', 'repository_googledocs');
    }
